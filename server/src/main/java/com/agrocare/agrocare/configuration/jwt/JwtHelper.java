...
public class JwtHelper {
    ...
    // Parse JWT token to retrieve any information from token
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        // Generate the token with specified claims and subject
        return Jwts.builder()
                .setClaims(claims)
                .setSubject(subject)
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        // Check if the username in the token matches the username from UserDetails and the token is not expired
